...
import 'manage_request_details_model.dart';
export 'manage_request_details_model.dart';
...
class _ManageRequestDetailsWidgetState
  ...
  late ManageRequestDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ManageRequestDetailsModel());
  }
      ...
      body: StreamBuilder<List<ExtraActsRecord>>(
        stream: queryExtraActsRecord(
          queryBuilder: (extraActsRecord) =>
              extraActsRecord.where('Act_ID', isEqualTo: widget.actsdetails),
          singleRecord: true,
        ),
