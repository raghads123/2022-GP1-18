...
import 'workshops_copy_model.dart';
export 'workshops_copy_model.dart';

class WorkshopsCopyWidget extends StatefulWidget {
  const WorkshopsCopyWidget({Key? key}) : super(key: key);

  @override
  _WorkshopsCopyWidgetState createState() => _WorkshopsCopyWidgetState();
}

class _WorkshopsCopyWidgetState extends State<WorkshopsCopyWidget> {
  late WorkshopsCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WorkshopsCopyModel());
