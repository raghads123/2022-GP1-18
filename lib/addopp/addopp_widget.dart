  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<OpportunitiesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<OpportunitiesRecord> addoppOpportunitiesRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final addoppOpportunitiesRecord =
            addoppOpportunitiesRecordList.isNotEmpty
                ? addoppOpportunitiesRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
                          ...
                          child: Row(
                            ...
                            children: [
                              FlutterFlowIconButton(
                                ...
                                onPressed: FFAppState().numskills == 10
                                    ? null
                                    : () async {
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            final opportunitiesCreateData = {
                              ...
                              'OpSkills': [oppskill1Controller!.text],
                            };
                            ...
                            final opportunitiesUpdateData = {
                              'OpSkills': FieldValue.arrayUnion(
                                  [oppskill2Controller!.text]),
                            };
                            await addoppOpportunitiesRecord!.reference
                                .update(opportunitiesUpdateData);
